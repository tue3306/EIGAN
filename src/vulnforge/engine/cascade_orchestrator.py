...
Envolve o :class:`~vulnforge.engine.orchestrator.Orchestrator` determinístico e
adiciona a camada de **cascata**: a cada finding produzido pelo pipeline, consulta
o :class:`~vulnforge.engine.cascade.CascadeGraph` para decidir — de forma pura e
...
log = logging.getLogger("vulnforge.cascade")
