...
def run_tui(*, db: str = "vulnforge.db", fallback: Callable[[], int] | None = None) -> int:
    ...
    class VulnForgeTUI(App):  # type: ignore[misc,type-arg]  # Textual opcional
        TITLE = "VulnForge"
        CSS = """
