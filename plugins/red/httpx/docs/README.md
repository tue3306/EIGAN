...
**Categoria:** red · **Capabilities:** web_probe

Probe de serviços web vivos + tech-detect. Guard de identidade contra o httpx do Python.
...
## Requisitos
- Binário externo `httpx` no PATH (ver `metadata.yaml::version_source`) ou via sandbox Docker.
